    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php">Bienvenido Socio</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="socio.php"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                            <a href="#" class="solicitar_prestamos"><i class="fa fa-book fa-fw"></i> Solicitar Prestamos</a>
                        </li>
                        <li>
                            <a href="#" class="consultar_multas"><i class="fa fa-search fa-fw"></i>Consultar Multas Pendientes</a>
                        </li>
                        <li>
                            <a href="#" class="maximo_libros"><i class="fa fa-bookmark fa-fw"></i>Número Máximo de Libros Solicitados</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="Principal">
            ...
            <div id="page-wrapper">
                ...
                <i ></i>     
                <center><img src="assets/img/socios.png" height="300" width="300" ></center>
                </div>
                </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-clock-o fa-fw"></i> L&iacute;nea de Tiempo Respectivo
                            </div>
                            <!-- /.panel-heading -->
                        ...
                        <div class="chat-panel panel panel-default">
                                ...
                                <ul class="chat">
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font">The Death note</strong>
                                    ...
                                    <li class="right clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                ...
                                                <strong class="pull-right primary-font">animex</strong>
                                            </div>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                            </p>
                                    ...
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font">Dragon Ball </strong>
                                                <small class="pull-right text-muted">
                                    ...
                                    <li class="right clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                ...
                                                <strong class="pull-right primary-font">akira toriyama</strong>
                                            </div>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                            </p>
                            ...
                            <div class="panel-footer">
                                <div class="input-group">
                                    <input id="btn-input" type="text" class="form-control input-sm" placeholder="write your message here..." />
                                    <span class="input-group-btn">
