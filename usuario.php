    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php">Bienvenido Usuario</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="usuario.php"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                            <a href="#" class="consultar_libros"><i class="fa fa-search fa-fw"></i>Consultar libros</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="Principal">
            <div id="page-wrapper">
                ...
                <i ></i>     
                <center><img src="assets/img/usuabibli.png" height="300" width="300"></center>
                </div>
                </div>
               <div class="panel panel-default">
                <div class="panel-heading">
                <i ></i>     
                <center><img src="assets/img/libros.png" height="300" width="300"></center>
                </div></div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                ...
                                <ul class="chat">
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font">Bleach</strong>
                                                <small class="pull-right text-muted">
                                                    <i class="fa fa-clock-o fa-fw"></i> Hace 5 Minutos
                                                </small>
                                            </div>
                                            <p>
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <small class=" text-muted">
                                                    <i class="fa fa-clock-o fa-fw"></i> Hace 17 Minutos</small>
                                    ...
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font">Los Hornos</strong>
                                                <small class="pull-right text-muted">
                                    ...
                                    <li class="right clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                ...
                                                <strong class="pull-right primary-font">Segunda Guerra Mundial</strong>
                                            </div>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                            </p>
